...
containerPosteos = document.getElementById("contenedor-posteos");
nombreFF = document.getElementById("nombre").value;
contenidoFF = document.getElementById("cajaposteos").value;
